# 
# Project automation script for My_Project_CDCE913 
# 
# Created for ISE version 14.3
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source My_Project_CDCE913.tcl), then you can
...
set myProject "My_Project_CDCE913"
set myScript "My_Project_CDCE913.tcl"
...
proc run_process {} {
   ...
   set task "Export Hardware Design To SDK with Bitstream"
   if { ! [run_task $task] } {
      puts "$myScript: $task run failed, check run output for details."
      project close
      return
...
proc add_source_files {} {
   ...
   xfile add "mb_system_top.vhd"
   xfile add "mb_system/mb_system.xmp"
   xfile add "mb_system.ucf"

   # Set the Top Module as well...
   project set top "STRUCTURE" "mb_system_top"
...
proc set_process_props {} {
   ...
   project set "Output File Name" "mb_system_top" -process "Generate IBIS Model"
