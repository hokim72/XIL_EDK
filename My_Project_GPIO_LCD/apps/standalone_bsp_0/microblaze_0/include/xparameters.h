...
/* Definitions for peripheral GPIO_LCD */
#define XPAR_GPIO_LCD_BASEADDR 0x40000000
#define XPAR_GPIO_LCD_HIGHADDR 0x4000FFFF
#define XPAR_GPIO_LCD_DEVICE_ID 0
#define XPAR_GPIO_LCD_INTERRUPT_PRESENT 0
#define XPAR_GPIO_LCD_IS_DUAL 0
